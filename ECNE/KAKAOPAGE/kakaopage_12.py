...
url = "https://page.kakao.com/landing/series/list/page/landing/50"
browser.implicitly_wait(10)
browser.maximize_window()
browser.get(url)
...
for i, href in enumerate(href_list, 1) :
    ...
    try :
        ...
        try : 
            ...
            browser.refresh()
        end_title = time.time()
        print(f"title : {end_title - start_title:.5f} sec")
        ...
        print(f"imgURL : {end_imgURL - start_imgURL:.5f} sec")
        ...
        print(f"upload_started : {end_upload_started - start_upload_started:.5f} sec")
        ...
        print(f"last_upload : {end_last_upload - start_last_upload:.5f} sec")
        try :
            detail = browser.find_element(By.XPATH, '//*[@id="__next"]/div/div[2]/div[1]/div[2]/div[1]/div/div[2]/a')
            detail.click()
        except :
        ...
        print(f"onlyAdult : {end_onlyAdult - start_onlyAdult:.5f} sec")
        ...
        print(f"author : {end_author - start_author:.5f} sec")
        ...
        try :
            ...
            print('genre ERROR')
        end_genre = time.time()
        print(f"genre : {end_genre - start_genre:.5f} sec")
        ...
        try : #발행자 위에꺼 가져와서 클래스네임으로 다 가져오기
            ...
            print('label ERROR')
        end_label = time.time()
        print(f"label : {end_label - start_label:.5f} sec")
...
with open(f'kakao12_{today}.json','w') as f:
